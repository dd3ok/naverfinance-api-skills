...
```text
https://github.com/dd3ok/naverfinance-api-skills 에서 스킬을 설치해줘.
```
...
git clone --depth 1 https://github.com/dd3ok/naverfinance-api-skills.git "$CODEX_SKILLS_DIR/naverfinance-web-api"
```
...
CODEX_SKILLS_DIR="${CODEX_HOME:-$HOME/.codex}/skills"
mkdir -p "$CODEX_SKILLS_DIR"
ln -sfn /path/to/naverfinance-api-skills "$CODEX_SKILLS_DIR/naverfinance-web-api"
```
...
git clone --depth 1 https://github.com/dd3ok/naverfinance-api-skills.git ~/.claude/skills/naverfinance-web-api
```
...
- [dd3ok/naverstock-api-skills](https://github.com/dd3ok/naverstock-api-skills): 새로운 네이버증권 Beta 페이지(`stock.naver.com`) 공개 read-only 웹 API, 국내 주식 시세, 업종/테마/ETF/뉴스/리서치 데이터.
- [dd3ok/tossinvest-api-skills](https://github.com/dd3ok/tossinvest-api-skills): 토스증권(TossInvest) 공개 read-only 웹 API, 시세, 차트, 재무, 뉴스, 공시, 테마, 지수, 랭킹, 스크리너 데이터.
